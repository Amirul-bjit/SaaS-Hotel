...
import { roomApi, roomFeatureApi, RoomFilters } from '@/lib/api';
import { RoomGlobalResponse, RoomFeatureDto } from '@/types';
      ...
      <div className="p-5 flex-1">
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="min-w-0 flex-1">
            ...
            {room.roomTypeName && (
              <span className="text-xs text-indigo-600 font-medium">{room.roomTypeName}</span>
            )}
            <div className="mt-1.5 flex items-center gap-1.5">
              ...
              <span className="text-xs text-gray-500 truncate">{room.hotelName}</span>
            </div>
            <div className="mt-0.5 flex items-center gap-1.5">
              ...
              <span className="text-xs text-gray-400 truncate">{room.hotelLocation}</span>
            </div>
          </div>
    ...
    <div className="min-h-[calc(100vh-64px)]">
      <div className="bg-gradient-to-br from-indigo-600 via-blue-700 to-blue-800 text-white">
        <div className="mx-auto max-w-7xl px-4 py-12">
          <h1 className="text-3xl font-extrabold tracking-tight">Room Marketplace</h1>
          <p className="mt-2 text-blue-200 max-w-xl">
            Browse all available rooms across every hotel on the platform. Filter by price, capacity, location, and amenities.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        <div className="mb-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-sm font-bold text-gray-700 uppercase tracking-wide">Filter Rooms</h2>
            {hasFilters && (
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border-2 border-dashed border-gray-200 bg-white py-20 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {hasFilters ? 'Try adjusting or clearing your filters.' : 'No rooms are available right now.'}
            </p>
            {hasFilters && (
          ...
          <>
            <div className="mb-5 flex items-center justify-between">
              <p className="text-sm text-gray-500">
                Showing <span className="font-semibold text-gray-700">{rooms.length}</span> room{rooms.length !== 1 ? 's' : ''}
